 ...
 * 
 * Internal storage order (opcode, C, A, B):
 ...
 * 
 * Note: User-facing format (files, display) shows OP A B C order but internally
 * wired as OP C A B for hardware compatibility.
 * 
